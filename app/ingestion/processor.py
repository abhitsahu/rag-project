...
processed_data_v1_DIR = "processed_data_v1"
...
def save_processed_locally(data: dict, source_type: str, filename: str) -> str:
    """Save parsed chunk metadata as JSON in processed_data_v1/<source_type>/."""
    folder = os.path.join(processed_data_v1_DIR, source_type)
...
def process_file(file_path: str, filename: str, source_type: str):
    ...
    with logfire.span("Processing File", file=filename, source=source_type):
        try:
            ...
            local_path = save_processed_locally(processed_data_v1, source_type, filename)
